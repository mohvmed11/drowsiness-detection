...
def face_for_yawn(direc="dataset/train", face_cas_path="haarcascade_frontalface_default.xml"):
    # Extract faces for yawn and not_yawn from the given directory.
    yaw_no = []
    IMG_SIZE = 145
...
def get_data(dir_path="dataset/train", face_cas="haarcascade_frontalface_default.xml", eye_cas="haarcascade.xml"):
    # Get data for closed and open eye from the given directory.
    labels = ['Closed', 'Open']
    IMG_SIZE = 145
    data = []
    for label in labels:
...
def append_data():
    # Append data from face_for_yawn and get_data functions.
